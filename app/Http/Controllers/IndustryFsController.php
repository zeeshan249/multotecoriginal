...
class IndustryFsController extends Controller
{
    ...
    public function allCategories() {
    	...
    	$DataBag['allCats'] = FlowsheetCategories::where('status', '!=', '3')->where('parent_language_id', '=', '0')
        //->where('parent_id', '=', '0')
    ...
    public function editCategory($fsc_id,Request $request) {
        ...
        if($DataBag['language_id']==1){
            ...
            $DataBag['fscategory'] = FlowsheetCategories::
            //where('parent_id',$fsc_id)->
            where('language_id', $DataBag['language_id'])->first();
