...
use App\Models\AnalyticsScripts;
use Image;
use Auth;
use DB;
...
class SettingsController extends Controller
{
    public function generalSettings() {
    	...
    	$dataBag['tmzList'] = DB::table('time_zone')->where('status', '=', '1')->orderBy('name', 'asc')->get();
    ...
    public function saveGeneralSettings(Request $request) {
    	...
    	if( empty($isExist) ) {
	    	...
	    	if( $request->hasFile('site_favicon') ) {
	            ...
	            $file_size = $site_favicon->getSize();
