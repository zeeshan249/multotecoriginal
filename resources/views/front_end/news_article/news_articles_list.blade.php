                            ...
                            <div class="col-sm-4 col-xs-4 bhoechie-tab-menu">
                                ...
                                @php if(!empty( $_GET['month'])){$month33 = $_GET['month'];} @endphp
                                  ...
                                  <div class="list-group">
                                    ...
                                    <a href="#" class="list-group-item @if(!empty($_GET['year'])) @if( $year22 == $yl ) active  @endif @elseif ( $i == '0' ) active @endif">
                                        {{ $yl }}
                                    </a>
                                    @php $i++; @endphp
                                    @endforeach
                            ...
                            <div class="col-sm-8 col-xs-8 bhoechie-tab">
                                @if( isset($yearList) )
                                    ...
                                    <div class="bhoechie-tab-content @if( $i == '0' ) active @endif">
                                        <ul>
                                            <li>
                                                <a href="?year={{ $yl }}&month=01" @if( isset($_GET['month']) && $_GET['month'] == '01') class="active" @endif>January</a>
                                            </li>
                                            <li>
                                                <a href="?year={{ $yl }}&month=02" @if( isset($_GET['month']) && $_GET['month'] == '02') class="active" @endif>February</a>
                                            </li>
                                            <li>
                                                <a href="?year={{ $yl }}&month=03"  @if( isset($_GET['month']) && $_GET['month'] == '03') class="active" @endif>March</a>
                                            </li>
                                            <li>
                                                <a href="?year={{ $yl }}&month=04"  @if( isset($_GET['month']) && $_GET['month'] == '04') class="active" @endif>April</a>
                                            </li>
                                            <li>
                                                <a href="?year={{ $yl }}&month=05"  @if( isset($_GET['month']) && $_GET['month'] == '05') class="active" @endif>May</a>
                                            </li>
                                            <li>
                                                <a href="?year={{ $yl }}&month=06"  @if( isset($_GET['month']) && $_GET['month'] == '06') class="active" @endif>June</a>
                                            </li>
                                            <li>
                                                <a href="?year={{ $yl }}&month=07"  @if( isset($_GET['month']) && $_GET['month'] == '07') class="active" @endif>July</a>
                                            </li>
                                            <li>
                                                <a href="?year={{ $yl }}&month=08"  @if( isset($_GET['month']) && $_GET['month'] == '08') class="active" @endif>August</a>
                                            </li>
                                            <li>
                                                <a href="?year={{ $yl }}&month=09"  @if( isset($_GET['month']) && $_GET['month'] == '09') class="active" @endif>September</a>
                                            </li>
                                            <li>
                                                <a href="?year={{ $yl }}&month=10"  @if( isset($_GET['month']) && $_GET['month'] == '10') class="active" @endif>October</a>
                                            </li>
                                            <li>
                                                <a href="?year={{ $yl }}&month=11"  @if( isset($_GET['month']) && $_GET['month'] == '11') class="active" @endif>November</a>
                                            </li>
                                            <li>
                                                <a href="?year={{ $yl }}&month=12"  @if( isset($_GET['month']) && $_GET['month'] == '12') class="active" @endif>December</a>
                                            </li>
                                        </ul>
                                    </div>
                                    @php $i++; @endphp
