...
<section class="container">
    ...
    <div class="breadcrumb" style="margin-top: 40px;"> <!-- Breadcrumb Segment -->
        <ul>
            <li><a href="{{ url('/') }}">Home</a></li>
            <li class="active"><a href="#">Product Brochures</a></li>
        </ul>
    </div>
...
<section class="container">
    <div class="midblock">
        <h1>Multotec product brochure</h1>
                    ...
                    <div class="tab_info_list">
                        <div class="row">
                            @if( isset($fileCategories) && count($fileCategories) > 0 )
                                ...
                                <div class="col-sm-4">
                                <ul><li>
                                    <a href="{{ route('prodBrochureCat', array('cat' => $pd->slug)) }}">{{ ucfirst($pd->name) }}</a>
                                </li></ul>    
                                </div>
                                @endforeach
                            @endif
