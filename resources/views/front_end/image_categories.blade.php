...
<section class="container">
    ...
    <div class="breadcrumb2"> <!-- Breadcrumb Segment -->
        <ul>
            ...
            <li class="active"><a href="#">Product Image Categories</a></li>
        </ul>
    </div>
...
<section class="container">
    <div class="midblock">
        <h1>Multotec Product Galleries</h1>
            ...
            <div class="jq-tab-wrapper" id="horizontalTab">
                ...
                <div class="jq-tab-content-wrapper">
                    ...
                    <div class="tab_info_list">
                        <div class="row">
                            @if( isset($imageCategories) && count($imageCategories) > 0 )
                                @foreach($imageCategories as $pd)
                                <div class="col-sm-4">
                                <ul><li>
                                    <a href="{{ route('front_galSubCat', array('lng' => $lng, 'category' => $pd->slug)) }}">{{ ucfirst($pd->name) }}</a>
                                </li></ul>    
                                </div>
                                @endforeach
                            @endif
