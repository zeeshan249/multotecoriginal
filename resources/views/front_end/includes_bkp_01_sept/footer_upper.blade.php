        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <ul class="footer-link">
                    <li><a id="toTop" class="backtotop" href="#"><i class="fa fa-arrow-up" aria-hidden="true"></i> <span class="hide">Back to top</span></a></li>
                    <li class="hidex"><a class="backtohome" href="#"><i class="fa fa-home" aria-hidden="true"></i> Back to Home</a></li>
                </ul>
            </div>
            <div class="col-sm-3 hidex" >
                <div class="footer-link">
                    <a class="contact" href="#"><i class="fa fa-phone" aria-hidden="true"></i> Contact Multotec</a>
                </div>
            </div>
        </div>
    </div>
