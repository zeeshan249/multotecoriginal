...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-10">
      <a href="{{ route('newsArticleList', array('lng' => 'en')) }}" class="btn btn-primary" target="_blank">View Page</a>
    </div>
  </div>
  <div class="row" style="margin-top: 10px;">
    <div class="col-md-12">
      ...
      <div class="box">
        ...
        <div class="box-body">
          <form name="frm" id="frmx" action="{{ route('art.extra_cont_save') }}" method="post" enctype="multipart/form-data">
          {{ csrf_field() }}
          <div class="row">
            <div class="col-md-10">
