...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="{{ route('prodCats') }}">All Webinar Topic</a></li>
    @if(isset($prodCat))
    <li class="active">Edit Webinar Topic</li>
    @else
    <li class="active">Add Webinar Topic</li>
    @endif
  </ol>
</section>
@endsection
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-6">
      <a href="{{ route('allWbTp') }}" class="btn btn-primary"> All Webinar Topic</a>
    ...
    <div class="col-md-12">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">@if(isset($prodCat)) Edit Webinar Topic @else Add Webinar Topic @endif</h3>
        ...
        <div class="box-body">
          <form name="jfrm" id="frmx" action="@if( isset($prodCat)){{ route('updateWbTp', array('id' => $content_id)) }}@else{{ route('saveWbTp') }}@endif" method="post" enctype="multipart/form-data">
          {{ csrf_field() }}
          ...
          <div class="row">
            <div class="col-md-10">
              <div class="form-group">
                <label>Webinar Topic : <em>*</em></label>
                <input type="text" name="name" id="scName" class="form-control" placeholder="Enter Webinar Topic" value="@if( isset($prodCat) ){{ $prodCat->name }}@endif">
              </div>
