...
<section class="content">
  ...
  <div class="row">
        ...
        <div class="box-body">
          ...
          {{ csrf_field() }}
              ...
              <div class="col-md-6" style="text-align: right;">
                <div class="form-group">
                  @if(isset($settings) && !empty($settings) && $settings->site_favicon != '' && $settings->site_favicon != null)
                    ...
                    @endphp
                    <img src="{{ $favURL }}" id="site_favicon_preview" class="ar_img_preview" 
                    data="{{ $favURL }}">
                  @else
                  <img src="{{ asset('public/images/no-image.png') }}" id="site_favicon_preview" class="ar_img_preview" 
                  data="{{ asset('public/images/no-image.png') }}">
                  @endif
            ...
            <div class="form-group" style="margin-top: 40px;">
              <label>Robots [Search Engine Visibility]</label>
            </div>
            <div class="form-group">
              <input type="checkbox" name="search_visibility" value="1" @if(isset($settings) && !empty($settings) && $settings->search_visibility == '1') checked="checked" @endif>
    ...
    <div class="col-md-4">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Log Information</h3>
