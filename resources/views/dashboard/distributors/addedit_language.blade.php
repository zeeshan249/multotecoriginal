...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-6">
      <a href="{{ route('allDistrib') }}" class="btn btn-primary"> All Distributors</a>
    </div>
    <div class="col-md-6">
    </div>
  </div>
    ...
    <div class="col-md-12">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">@if(isset($distributor)) Edit Distributor @else Add Distributor @endif</h3>
        ...
        <div class="box-body">
          <form name="jfrm" id="frmx" action="@if( isset($distributor) ){{ route('distrb.adedlngPst', array('pid' => $parentLngCont->id, 'cid' => $distributor->id)) }}@else{{ route('distrb.adedlngPst', array('pid' => $parentLngCont->id)) }}@endif" method="post" enctype="multipart/form-data">
          {{ csrf_field() }}

          <div class="row">
            @if(isset($distributor) && isset($distributor->Language)) 
            <div class="col-md-3">
              <div class="form-group">
                <div class="input-group">
                  <div class="input-group-addon">
                    <span>
                    <img src="{{ asset('public/uploads/flags/thumb/'. $distributor->Language->flag) }}" style="height: 20px;" id="flag">
                    </span>
                  </div>
                  <select name="language_id" id="language_id" class="form-control">
                    <option value="{{ $distributor->language_id }}">{{ $distributor->Language->name }}</option>
                  </select>
                </div>
              </div>
            </div>
            ...
            @if(isset($distributor))
            <a href="{{ route('distrb.adedlngDel', array('pid' => $parentLngCont->id, 'cid' => $distributor->id)) }}" class="btn btn-danger pull-right" onclick="return confirm('Are You Sure Want To Delete This Content ?')">Delete This Content</a>
            @endif
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-10">
              <div class="form-group">
                <label>Distributor Name (H1): <em>*</em></label>
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <select name="follow" class="form-control">
                  <option value="0" @if(isset($distributor) && $distributor->follow == '0') selected="selected" @endif>NO</option>
                  <option value="1" @if(isset($distributor) && $distributor->follow == '1') selected="selected" @endif>YES</option>
                </select>
              </div>
            </div>
            <div class="col-md-3">
              <div class="form-group">
                ...
                <select name="index_tag" class="form-control">
                  <option value="0" @if(isset($distributor) && $distributor->index_tag == '0') selected="selected" @endif>NO</option>
                  <option value="1" @if(isset($distributor) && $distributor->index_tag == '1') selected="selected" @endif>YES</option>
                </select>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-10">
              ...
              <div class="form-group">
                ...
                @endphp
                <label>Distributor Categories :</label>
                <select name="distributor_category_id[]" id="distributor_category_id" multiple="multiple">
              ...
              <div class="form-group">
                ...
                @if( isset($distributor) )
                {{--<span>
                  <a href="{{ route('previewTool') }}?url={{ route('preview', array('device' => 'desktop', 'slug' => $distributor->slug)) }}&device=desktop" target="_blank" data-toggle="tooltip" data-placement="bottom" title="Desktop Preview">
