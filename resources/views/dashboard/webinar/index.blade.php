...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">All Webinar</li>
  </ol>
</section>
@endsection
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-6">
      <a href="{{ route('addWb') }}" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> Create New
        Webinar</a>
    </div>
    <div class="col-md-6">
    </div>
  ...
  <div class="box" style="margin-top: 10px;">
    ...
    <form name="frmx" action="{{ route('webiDWN') }}" method="post">
      {{ csrf_field() }}
      <div class="box-header with-border">
        <h3 class="box-title">All Webinar</h3>
        <!-- Start -->
