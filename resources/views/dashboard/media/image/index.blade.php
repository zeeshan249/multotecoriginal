...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-6">
      <a href="{{ route('media_img_add') }}" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> Add New Image</a>
    </div>
    <div class="col-md-6">
    </div>
  </div>
  ...
  <div class="box" style="margin-top: 10px;">
    ...
    <div class="box-body">
      ...
      <div class="row">
        <div class="col-md-3">
          <input type="submit" class="btn btn-xs btn-danger" value="Delete Selected" disabled="disabled" id="delAll" onclick="return confirm('Are You Sure To Delete Selected Images ?');">
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
          <table class="table table-bordered table-hover table-striped">
            ...
            @if(isset($allImages))
              ...
              <tr class="x">
                ...
                <td>
                  @if( isset($img->getCatSubcat) && !empty($img->getCatSubcat) )
                    @if( isset($img->getCatSubcat->categoryInfo) && !empty($img->getCatSubcat->subcategoryInfo) )
                      {{ $img->getCatSubcat->subcategoryInfo->name }}
                    @endif
                  @endif
                </td>
              </tr>
