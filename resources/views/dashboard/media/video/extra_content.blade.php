...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-10">
      <a href="{{ route('vid_gal_cats', array('lng' => 'en')) }}" class="btn btn-primary" target="_blank">View Page</a>
    </div>
  </div>
    ...
    <div class="col-md-12">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Add - Edit - Frontend Extra Content For Video Section</h3>
        ...
        <div class="box-body">
          <form name="frm" id="frmx" action="{{ route('media.vid_extra_cont_save') }}" method="post" enctype="multipart/form-data">
          {{ csrf_field() }}
          <div class="row">
            <div class="col-md-10">
