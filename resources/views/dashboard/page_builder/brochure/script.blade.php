...
$( function() {
  ...
  var pgb_BROCHBTN_frm = $('#pgb_BROCHBTN_frm');
  
  pgb_BROCHBTN_frm.validate({
      errorElement: 'span',
              ...
              var html = '<div class="notice notice-info">';
                  html += '<div class="row">';
                    ...
                    html += '<div class="col-md-4 txtrit">';
                      html += '<a href="javascript:void(0);" class="pgb_edt" id="' + BROCHURE_BUTT_thisID + '" data="BROCHURE_BUTT"><i class="fa fa-pencil base-green fa-2x" aria-hidden="true"></i></a>';
                      html += '&nbsp;&nbsp;'
                      html += '<a href="javascript:void(0);" class="pgb_del" id="' + BROCHURE_BUTT_thisID + '" data="BROCHURE_BUTT"><i class="fa fa-trash-o base-red fa-2x" aria-hidden="true"></i></a>';
                    html += '</div>';
                  html += '</div>';
                html += '</div>';

              if( action_status == 'insert' ) {
                $('#pgContentAppend').append('<div class="ar-order altTop '+ builder_type +'_holder_' + BROCHURE_BUTT_thisID +'" id="' + BROCHURE_BUTT_thisID + '">' + html + '</div>');
              }

              if( action_status == 'update' ) {
                $('.'+ builder_type +'_holder_' + BROCHURE_BUTT_thisID).html( html );
              }
            }
            form.reset();
          },
