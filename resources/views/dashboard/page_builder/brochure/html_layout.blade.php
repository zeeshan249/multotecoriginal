    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">
          <strong><i class="fa fa-random" aria-hidden="true"></i> Extra Media - Add Download Brochure Button</strong>
        </h4>
      </div>
      <div class="modal-body modal_min_height">
        <form name="pgb_BROCHBTN_frm" id="pgb_BROCHBTN_frm" action="{{ route('pgbAddEdt') }}" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <select name="main_content" class="form-control" id="file_category">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <select name="sub_content" class="form-control" id="file_subcategory">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="hidden" name="builder_type" value="BROCHURE_BUTT">
            </div>
          </div>
        </div>
      </form>
