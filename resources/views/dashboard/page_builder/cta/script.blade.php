...
$( function() {
	$('body').on('click', '.pgb_cta', function() {
	...
	var pgb_cta_frm = $('#pgb_cta_frm');
	
	pgb_cta_frm.validate({
  		errorElement: 'span',
		...
		messages: {
		    ...
		    link_text: {
		      required: 'Please Enter CTA Text.'
		    },
		    link_url: {
		    ...
		    main_title: {
		    	required: 'Please Enter CTA Title.'
		    },
		    builder_type: {
		        	...
		        	var html = '<div class="notice notice-info">';
		        			html += '<div class="row">';
		        				...
		        				html += '<div class="col-md-4 txtrit">';
		        					html += '<a href="javascript:void(0);" class="pgb_edt" id="' + CTA_thisID + '" data="CTA"><i class="fa fa-pencil base-green fa-2x" aria-hidden="true"></i></a>';
		        					html += '&nbsp;&nbsp;'
		        					html += '<a href="javascript:void(0);" class="pgb_del" id="' + CTA_thisID + '" data="CTA"><i class="fa fa-trash-o base-red fa-2x" aria-hidden="true"></i></a>';
		        				html += '</div>';
		        			html += '</div>';
		        		html += '</div>';

		        	if( action_status == 'insert' ) {
		        		$('#pgContentAppend').append('<div class="ar-order altTop '+ builder_type +'_holder_' + CTA_thisID + '" id="' + CTA_thisID +'">' + html + '</div>');
		        	}

		        	if( action_status == 'update' ) {
		        		$( '.'+ builder_type +'_holder_' + CTA_thisID ).html( html );
		        	}
		        }
		        form.reset();
		      },
