<!-- Modal -->
<div id="pgb_herostat_cw_modal" class="modal fade" role="dialog">
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form name="pgb_herostat_cw_frm" id="pgb_herostat_cw_frm" action="{{ route('pgbAddEdt') }}" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="row">
          <div class="col-md-3">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              <label>Container Width Content</label>
              <input type="text" name="main_content" id="HERO_SCW_main_content" class="form-control" placeholder="Container Width Hero Statement">
            </div>
            <div class="form-group">
              ...
              @endif
              <input type="hidden" name="builder_type" value="HERO_SCW">
              <input type="hidden" class="this_id" name="this_id" id="HERO_SCW_this_id" value="0">
            </div>
          </div>
        </div>
        </form>
