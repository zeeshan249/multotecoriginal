...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">All Source Type</li>
      </ol>
    </section>
@endsection
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-6">
      <a href="{{ route('addSrc') }}" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> Create New Source Type</a>
    </div>
    <div class="col-md-6">
    </div>
  </div>
  ...
  <div class="box" style="margin-top: 10px;">
    ...
    <div class="box-header with-border">
      <h3 class="box-title">All Source Type</h3>
        ...
        @if(isset($allProdCats))
          ...
          <tr>
            ...
            <td>
              ...
              @php $url=route('editSrc', array('id' => $pc->id))  @endphp

              <a href="{{ route('editSrc', array('id' => $pc->id)) }}"><i class="fa fa-pencil-square-o fa-2x base-green"></i></a>
              <a href="{{ route('delSrc', array('id' => $pc->id)) }}" onclick="return confirm('Sure To Delete This Item ?');"><i class="fa fa-2x fa-trash-o base-red"></i></a>
              
             
             </td>
            <td>
              @if($pc->status == '1')
                <a href="{{ route('acInac') }}?id={{ $pc->id }}&val=2&tab=source_type"> 
