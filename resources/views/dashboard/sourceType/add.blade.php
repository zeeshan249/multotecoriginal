...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="{{ route('prodCats') }}">All Source Type</a></li>
    @if(isset($prodCat))
    <li class="active">Edit Source Type</li>
    @else
    <li class="active">Add Source Type</li>
    @endif
  </ol>
</section>
@endsection
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-6">
      <a href="{{ route('allSrc') }}" class="btn btn-primary"> All Source Type</a>
    ...
    <div class="col-md-12">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">@if(isset($prodCat)) Edit Source Type @else Add Source Type @endif</h3>
        ...
        <div class="box-body">
          <form name="jfrm" id="frmx" action="@if( isset($prodCat)){{ route('updateSrc', array('id' => $content_id)) }}@else{{ route('saveSrc') }}@endif" method="post" enctype="multipart/form-data">
          {{ csrf_field() }}
          ...
          <div class="row">
            <div class="col-md-10">
              <div class="form-group">
                ...
                <input type="text" name="name" id="scName" class="form-control" placeholder="Enter Source Type" value="@if( isset($prodCat) ){{ $prodCat->name }}@endif">
              </div>
