...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">All Event Type</li>
      </ol>
    </section>
@endsection
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-6">
      <a href="{{ route('addEventManagementType') }}" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> Create New Event Type</a>
    </div>
    <div class="col-md-6">
    </div>
  </div>
  ...
  <div class="box" style="margin-top: 10px;">
    ...
    <div class="box-header with-border">
      <h3 class="box-title">All Event Type</h3>
        ...
        @if(isset($allProdCats))
          ...
          <tr>
            ...
            <td>
              ...
              @php $url=route('editEventType', array('id' => $pc->id))  @endphp

              <a href="{{ route('editEventType', array('id' => $pc->id)) }}"><i class="fa fa-pencil-square-o fa-2x base-green"></i></a>
            ...
            <td>
              @if($pc->status == '1')
                <a href="{{ route('acInacEventType') }}?id={{ $pc->id }}&val=0&tab=webinar_industry"> 
                  <i class="fa fa-check-circle-o base-green fa-2x" aria-hidden="true"></i> 
                </a>
              @endif
              @if($pc->status == '0')
                <a href="{{ route('acInacEventType') }}?id={{ $pc->id }}&val=1&tab=webinar_industry"> 
