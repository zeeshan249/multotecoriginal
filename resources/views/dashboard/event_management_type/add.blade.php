...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="{{ route('prodCats') }}">All Event Types</a></li>
    @if(isset($prodCat))
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-6">
      <a href="{{ route('allEventManagementType') }}" class="btn btn-primary"> All Event Type</a>
    ...
    <div class="col-md-12">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">@if(isset($prodCat)) Edit Event Type @else Add Event Type @endif</h3>
        ...
        <div class="box-body">
          <form name="jfrm" id="frmx" action="@if( isset($prodCat)){{ route('updateEventType', array('id' => $content_id)) }}@else{{ route('addEventType') }}@endif" method="post" enctype="multipart/form-data">
          {{ csrf_field() }}
          ...
          <div class="row">
            <div class="col-md-10">
              <div class="form-group">
                ...
                <input type="text" name="name" id="name" class="form-control" placeholder="Enter Event Type" value="@if( isset($prodCat) ){{ $prodCat->name }}@endif">
...
$(document).ready(function() {
      ...
      function validateForm() {
        ...
        if (name === "") {
          $("#nameError").text("Please enter Event Type.");
          isValid = false;
        } else {
          $("#nameError").text("");
        }
