...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="{{ asset('public/assets/bootstrap-datetimepicker.min.css') }}">
  <link rel="stylesheet" type="text/css" href="{{ asset('public/assets/bootstrap-datepicker3.min.css') }}">
