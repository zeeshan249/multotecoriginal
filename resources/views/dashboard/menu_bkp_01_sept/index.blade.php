...
$( function() {
  ...
  $('body').on('click', '.savePageDetails', function() {
    ...
    $('body .lng_nav_id').each( function() {

    	var lngnavid = $.trim($(this).val());
    	if( lngnavid != 0 && lngnavid != '0' ) {
	    	var _itsID = $(this).attr('id');
	    	var _itsIdArr = _itsID.split('_');
	    	var _getid = _itsIdArr[1];
	    	var innerArray = {};
	    	innerArray['page_url'] = $('#lngpgurl_' + _getid).val();
	    	innerArray['label_txt'] = $('#lnglabel_' + _getid).val();
	    	innerArray['label_attr'] = $('#lngattr_' + _getid).val();
	    	innerArray['is_link'] = is_link;
	    	collection[ lngnavid ] = innerArray;
    	}
    } );
