  ...
  <div class="row" style="margin-top: 10px;">
    <div class="col-md-12">
      ...
      <div class="box">
        ...
        <div class="box-body">
          <form name="jfrm" id="frmx" action="@if( isset($prodCat) ){{ route('prod.adedcatlngPst', array('pid' => $parentLngCont->id, 'cid' => $prodCat->id)) }}@else{{ route('prod.adedcatlngPst', array('pid' => $parentLngCont->id)) }}@endif" method="post" enctype="multipart/form-data">
          {{ csrf_field() }}

          <div class="row">
            @if(isset($prodCat) && isset($prodCat->Language)) 
            <div class="col-md-3">
              <div class="form-group">
                <div class="input-group">
                  <div class="input-group-addon">
                    <span>
                    <img src="{{ asset('public/uploads/flags/thumb/'. $prodCat->Language->flag) }}" style="height: 20px;" id="flag">
                    </span>
                  </div>
                  <select name="language_id" id="language_id" class="form-control">
                    <option value="{{ $prodCat->language_id }}">{{ $prodCat->Language->name }}</option>
                  </select>
                </div>
              </div>
            </div>
            ...
            @if(isset($prodCat))
            <a href="{{ route('prod.adedcatlngDel', array('pid' => $parentLngCont->id, 'cid' => $prodCat->id)) }}" class="btn btn-danger pull-right" onclick="return confirm('Are You Sure Want To Delete This Content ?')">Delete This Content</a>
            @endif
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-10">
              <div class="form-group">
                <label>Category or Subcategory Name (H1): <em>*</em></label>
              ...
              <div class="form-group">
                ...
                <input type="text" name="slug" id="pgSlug" class="form-control" placeholder="Enter Link or Page URL" value="@if( isset($prodCat) ){{ $prodCat->slug }}@endif" @if( isset($prodCat) ) readonly="readonly" @endif>
              </div>
              <div class="form-group">
          ...
          <div class="row">
            <div class="col-md-10">
              <div class="form-group">
                ...
                --}}
                <textarea name="page_content" class="form-control" id="pg_cont">@if( isset($prodCat) ){{ html_entity_decode($prodCat->page_content, ENT_QUOTES) }}@endif</textarea>
              </div>
            </div>
          </div>
