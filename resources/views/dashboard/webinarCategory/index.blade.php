...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">All Webinar Product</li>
      </ol>
    </section>
@endsection
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-6">
      <a href="{{ route('addWbCt') }}" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> Create New Webinar Product</a>
    </div>
    <div class="col-md-6">
    </div>
  </div>
  ...
  <div class="box" style="margin-top: 10px;">
    ...
    <div class="box-header with-border">
      <h3 class="box-title">All Webinar Product</h3>
        ...
        @if(isset($allProdCats))
          ...
          <tr>
            ...
            <td>
              ...
              @php $url=route('editWbCt', array('id' => $pc->id))  @endphp

              <a href="{{ route('editWbCt', array('id' => $pc->id)) }}"><i class="fa fa-pencil-square-o fa-2x base-green"></i></a>
              <a href="{{ route('delWbCt', array('id' => $pc->id)) }}" onclick="return confirm('Sure To Delete This Item ?');"><i class="fa fa-2x fa-trash-o base-red"></i></a>
              
             
             </td>
            <td>
              @if($pc->status == '1')
                <a href="{{ route('acInac') }}?id={{ $pc->id }}&val=2&tab=webinar_category"> 
                  <i class="fa fa-check-circle-o base-green fa-2x" aria-hidden="true"></i> 
                </a>
              @endif
              @if($pc->status == '2')
                <a href="{{ route('acInac') }}?id={{ $pc->id }}&val=1&tab=webinar_category"> 
