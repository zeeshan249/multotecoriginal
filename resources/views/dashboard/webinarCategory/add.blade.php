...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="{{ route('prodCats') }}">All Webinar Product</a></li>
    @if(isset($prodCat))
    <li class="active">Edit Webinar Product</li>
    @else
    <li class="active">Add Webinar Product</li>
    @endif
  </ol>
</section>
@endsection
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-6">
      <a href="{{ route('allWbCt') }}" class="btn btn-primary"> All Webinar Product</a>
    ...
    <div class="col-md-12">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">@if(isset($prodCat)) Edit Webinar Product @else Add Webinar Product @endif</h3>
        ...
        <div class="box-body">
          <form name="jfrm" id="frmx" action="@if( isset($prodCat)){{ route('updateWbCt', array('id' => $content_id)) }}@else{{ route('saveWbCt') }}@endif" method="post" enctype="multipart/form-data">
          {{ csrf_field() }}
          ...
          <div class="row">
            <div class="col-md-10">
              <div class="form-group">
                <label>Webinar Product : <em>*</em></label>
                <input type="text" name="name" id="scName" class="form-control" placeholder="Enter Webinar Product" value="@if( isset($prodCat) ){{ $prodCat->name }}@endif">
              </div>
