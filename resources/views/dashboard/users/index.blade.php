          ...
          <tr>
            ...
            <td>
              @if( isset($user->roles) )
                ...
                <a href="{{-- route('rlMnPer', array('role_id' => $ur->id)) --}}">
                  <span class="label label-default">{{ ucwords($ur->name) }}</span>
                </a>
                @endforeach
              @endif
            </td>
            ...
            <td>
              <a href="{{ route('edit_user', array('user_timestamp_id' => $user->timestamp_id)) }}" data-toggle="tooltip" data-placement="bottom" title="Edit User"><i class="fa fa-2x fa-pencil-square-o base-green"></i></a>

              <a href="{{ route('del_usr', array('user_timestamp_id' => $user->timestamp_id)) }}" data-toggle="tooltip" data-placement="bottom" title="Delete User" onclick="return confirm('Are You Sure You Want To Delete This User ?');"><i class="fa fa-2x fa-trash-o base-red"></i></a>

              <a href="{{ route('rst_pwd', array('user_timestamp_id' => $user->timestamp_id)) }}" data-toggle="tooltip" data-placement="bottom" title="Reset Password"><i class="fa fa-2x fa-key"></i></a>
            </td>
          </tr>
          @php $sl++; @endphp
          @empty
