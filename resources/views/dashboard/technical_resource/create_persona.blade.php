  ...
  <div class="row" style="margin-top: 10px;">
    <div class="col-md-12">
      ...
      <div class="box">
        ...
        <div class="box-body">
          <form name="jfrm" id="frmx" action="@if( isset($persona) ){{ route('updatePersona', array('id' => $persona->id)) }}@else{{ route('svePersona') }}@endif" method="post" enctype="multipart/form-data">
          {{ csrf_field() }}
          ...
          <div class="row">
            ...
            <div class="col-md-9" style="text-align: right;">
              @if( isset($persona) && !empty($persona) )
                @if( isset($persona->ChildLanguages) && count($persona->ChildLanguages) < count($languages) - 1 )
                <a href="{{ route('techr.adedcatlng', array('pid' => $persona->id)) }}"><i class="fa fa-plus"></i> Add Language ?</a>
                @endif
                @if( isset($persona->ChildLanguages) )
                  @foreach( $persona->ChildLanguages as $chl )
                    @if( isset($chl->Language) )
                      @php $Lng = $chl->Language; @endphp
                      <a href="{{ route('techr.adedcatlng', array('pid' => $persona->id, 'cid' => $chl->id)) }}" class="lngLink btn btn-xs">
