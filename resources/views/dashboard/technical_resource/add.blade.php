...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-6">
      ...
      <a href="{{ route('viewTechResLst', array('lng' => 'en')) }}" class="btn btn-warning" target="_blank">View Page</a>
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" name="publish_date" class="form-control datepicker" placeholder="Publish Date" value="@if( isset($resource) && $resource->publish_date != '' ){{ date('d-m-Y', strtotime($resource->publish_date)) }}@endif">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <label>Display Order :</label>
                <input type="text" name="display_order" class="form-control onlyNumber" style="width: 100px;" @if( isset($resource) ) value="{{ $resource->display_order }}" @else value="0" @endif>
              </div>
            </div>
          </div>
