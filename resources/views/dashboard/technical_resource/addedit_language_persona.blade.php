...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="{{ route('allPersonas') }}">All Categories</a></li>
  </ol>
</section>
@endsection
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-6">
      <a href="{{ route('allPersonas') }}" class="btn btn-primary"> All Categories</a>
    </div>
    <div class="col-md-6">
    </div>
  </div>
    ...
    <div class="col-md-12">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">@if(isset($persona)) Edit Category @else Add Category @endif</h3>
        ...
        <div class="box-body">
          <form name="jfrm" id="frmx" action="@if( isset($persona) ){{ route('techr.adedcatlngPst', array('pid' => $parentLngCont->id, 'cid' => $persona->id)) }}@else{{ route('techr.adedcatlngPst', array('pid' => $parentLngCont->id)) }}@endif" method="post" enctype="multipart/form-data">
          {{ csrf_field() }}

          <div class="row">
            @if(isset($persona) && isset($persona->Language)) 
            <div class="col-md-3">
              <div class="form-group">
                <div class="input-group">
                  <div class="input-group-addon">
                    <span>
                    <img src="{{ asset('public/uploads/flags/thumb/'. $persona->Language->flag) }}" style="height: 20px;" id="flag">
                    </span>
                  </div>
                  <select name="language_id" id="language_id" class="form-control">
                    <option value="{{ $persona->language_id }}">{{ $persona->Language->name }}</option>
                  </select>
                </div>
              </div>
            </div>
            ...
            @if(isset($persona))
            <a href="{{ route('techr.adedcatlngDel', array('pid' => $parentLngCont->id, 'cid' => $persona->id)) }}" class="btn btn-danger pull-right" onclick="return confirm('Are You Sure Want To Delete This Content ?')">Delete This Content</a>
            @endif
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-10">
              <div class="form-group">
                <label>Persona Name (H1): <em>*</em></label>
                <input type="text" name="name" class="form-control" id="persName" placeholder="Enter Profile Category Name" value="@if( isset($persona) ){{ $persona->name }}@endif">
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-10">
              <div class="form-group">
                ...
                <input type="text" name="slug" class="form-control" id="pgSlug" placeholder="Enter Link or URL" value="@if( isset($persona) ){{ $persona->slug }}@endif" @if( isset($persona) ) readonly="readonly" @endif>
              </div>
              <div class="form-group">
                <label>Short Description :</label>
                <textarea name="description" class="form-control">@if( isset($persona) ){{ html_entity_decode($persona->description, ENT_QUOTES) }}@endif</textarea>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-10">
              <div class="form-group">
                ...
                <input type="text" name="meta_title" class="form-control" placeholder="Meta Title" value="@if( isset($persona) ){{ $persona->meta_title }}@endif">
              </div>
              <div class="form-group">
                <label>Meta Keywords:</label>
                <input type="text" name="meta_keyword" class="form-control" placeholder="Meta Keywords" value="@if( isset($persona) ){{ $persona->meta_keyword }}@endif">
              </div>
              <div class="form-group">
                <label>Meta Description:</label>
                <textarea name="meta_desc" class="form-control" placeholder="Meta Description">@if( isset($persona) ){{ $persona->meta_desc }}@endif</textarea>
              </div>
              <div class="form-group">
                <label>Canonical Url:</label>
                <input type="text" name="canonical_url" class="form-control" placeholder="Any Canonical url" value="@if( isset($persona) ){{ $persona->canonical_url }}@endif">
              </div>
            </div>
            <div class="col-md-3">
              <div class="form-group">
                <label>Language Tag:</label>
                <input type="text" name="lng_tag" class="form-control" placeholder="Language Tag" value="@if( isset($persona) ){{ $persona->lng_tag }}@endif">
              </div>
            </div>
            <div class="col-md-3">
              <div class="form-group">
                ...
                <select name="follow" class="form-control">
                  <option value="0" @if(isset($persona) && $persona->follow == '0') selected="selected" @endif>NO</option>
                  <option value="1" @if(isset($persona) && $persona->follow == '1') selected="selected" @endif>YES</option>
                </select>
              </div>
            </div>
            <div class="col-md-3">
              <div class="form-group">
                ...
                <select name="index_tag" class="form-control">
                  <option value="0" @if(isset($persona) && $persona->index_tag == '0') selected="selected" @endif>NO</option>
                  <option value="1" @if(isset($persona) && $persona->index_tag == '1') selected="selected" @endif>YES</option>
                </select>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-10">
              <div class="form-group">
                ...
                <textarea name="page_content" id="pgCont" class="form-control">@if( isset($persona) ){{ html_entity_decode($persona->page_content, ENT_QUOTES) }}@endif</textarea>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-6">
              ...
              <input type="hidden" id="table_id" value="{{ $persona->id }}">
              <input type="hidden" name="insert_id" id="insert_id" value="{{ $persona->insert_id }}">
              @else
