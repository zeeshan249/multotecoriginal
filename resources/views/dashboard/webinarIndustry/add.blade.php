...
<section class="content-header">
  <h1>
    @if(isset($prodCat))
    Edit Webinar Industry
    @else
    Add Webinar Industry
    @endif
    <!--small>it all starts here</small-->
  </h1>
  <ol class="breadcrumb">
    <li><a href="{{ route('dashboard') }}"><i class="fa fa-dashboard"></i> Home</a></li>
    <li><a href="{{ route('prodCats') }}">All Webinar Industry</a></li>
    @if(isset($prodCat))
    <li class="active">Edit Webinar Industry</li>
    @else
    <li class="active">Add Webinar Industry</li>
    @endif
  </ol>
</section>
@endsection
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-6">
      <a href="{{ route('allWbId') }}" class="btn btn-primary"> All Webinar Industry</a>
    ...
    <div class="col-md-12">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">@if(isset($prodCat)) Edit Webinar Industry @else Add Webinar Industry @endif</h3>
        ...
        <div class="box-body">
          <form name="jfrm" id="frmx" action="@if( isset($prodCat)){{ route('updateWbId', array('id' => $content_id)) }}@else{{ route('saveWbId') }}@endif" method="post" enctype="multipart/form-data">
          {{ csrf_field() }}
          ...
          <div class="row">
            <div class="col-md-10">
              <div class="form-group">
                ...
                <input type="text" name="name" id="scName" class="form-control" placeholder="Enter Webinar Industry" value="@if( isset($prodCat) ){{ $prodCat->name }}@endif">
              </div>
