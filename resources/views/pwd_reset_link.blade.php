...
<div class="login-box" style="position: absolute; top: 0px; left: 35%; z-index: 9999;">
  ...
  <div class="login-box-body" style="box-shadow: 0px 0px 2px black;">
    ...
    <span style="font-size: 18px;"><strong>{{ $siteName }}</strong></span><br/>Password Reset Link</p>

    <form name="frm" id="frmx" action="{{ route('send_link') }}" method="post" autocomplete="off">
    {{ csrf_field() }}
      <div class="form-group has-feedback">
        <input type="email" name="email_id" class="form-control" placeholder="Enter Registered Email" autocomplete="off">
    ...
    <!-- /.social-auth-links -->
    <br/>
    <a href="{{ route('dashboard_login') }}">Member Login</a><br>
